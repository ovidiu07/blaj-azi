...
export const siteContentDefinitions: readonly SiteContentDefinition[] = [
  ...
  },
  {
    ...
    fields: [{ path: "heroImage", label: "Imagine principală", kind: "image", required: true }, text("kicker", "Supratitlu"), text("title", "Titlu"), text("intro", "Introducere", "multiline", 1000), text("lead", "Text introductiv", "multiline", 1200), text("supportingCopy", "Text secundar", "multiline", 1200), text("sourceLabel", "Etichetă sursă"), text("sourceUrl", "Sursă", "external-url", 800), text("sectionEyebrow", "Secțiune — supratitlu"), text("sectionTitle", "Secțiune — titlu"), text("emptyTitle", "Stare goală — titlu"), text("emptyCopy", "Stare goală — text", "multiline", 800), text("galleryEyebrow", "Galerie — supratitlu"), text("galleryTitle", "Galerie — titlu"), text("contributionKicker", "Contribuție — supratitlu"), text("contributionTitle", "Contribuție — titlu"), text("contributionCopy", "Contribuție — text", "multiline", 1000), text("contributionLabel", "Contribuție — acțiune"), text("contributionHref", "Contribuție — link", "internal-link", 300)],
  },
