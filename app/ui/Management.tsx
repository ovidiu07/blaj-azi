...
export const statusLabels: Record<string, string> = {
  ...
  scheduled: "Programat", published: "Publicat", rejected: "Respins", archived: "Arhivat", soft_deleted: "Șters",
};
...
export function ContentEditor({ initial, businesses }: { initial?: ContentItem; businesses: BusinessOption[] }) {
  ...
  const locked = saved?.status === "pending_review";
  return <>
    <form className="content-editor" onSubmit={save}>
      ...
      {locked && <div className="moderation-note"><strong>Materialul este în verificare.</strong><span>Retrage trimiterea înainte de a-l modifica.</span></div>}
      ...
      <label className="media-upload"><Upload /><span>Fotografiile se încarcă din biblioteca media. Alt textul este obligatoriu înainte de publicare.</span><input name="media" type="file" accept="image/jpeg,image/png,image/webp" disabled={locked} /></label>
